...
class SponsoredProductResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'related_product' => Product::where('category_id', $this->product->category_id)
                ->Orwhere('store_id', $this->product->store_id)->get(),
        ];
    }
}
