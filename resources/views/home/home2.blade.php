                            ...
                            <div class="cart-toggle hidden-xs hidden-sm">
                                <div class="cart-overflow">
                                    <div class="cart-entry clearfix">
                                        <a class="cart-entry-thumbnail" href="/#"><img src="/img/product-1.png"
                                                                                      alt="" /></a>
            ...
            <div class="content-margins">
                <div class="row">
                    <div class="col-xs-3 col-sm-1">
                        <a id="logo" href="/index.html"><img src="/img/ceflix2.png" alt="" /></a>
                    </div>
                        ...
                        <div class="nav-wrapper">
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        <a href="/">Graphics Templates</a>
                                        <div class="menu-toggle"></div>
                                        <ul>
                                            <li>
                                                <a href="/blog3.html">Birthday Designs</a>
                                            </li>
                                            <li>
                                                <a href="/blog3.html">Brochures and Magazines</a>
                                            </li>
                                            <li>
                                                <a href="/blog3.html">Business Cards</a>
                                            </li>
                                            <li>
                                                <a href="/blog3.html">Business Designs</a>
                                            </li>
                                            <li>
                                                <a href="/blog3.html">Certificate Designs</a>
                                            </li>
                                            <li>
                                                <a href="/blog3.html">Church Designs</a>
                                            </li>
                                            <li>
                                                <a href="/blog3.html">Flyer Designs</a>
                                            </li>
                                            <li>
                                                <a href="/blog3.html">Happy New Year</a>
                                            </li>
                                            <li>
                                                <a href="/blog3.html">Roll Up Banners</a>
                                            </li>
                                            <li>
                                                <a href="/blog3.html">Valentine Designs</a>
                                            </li>
                                            <li>
                                                <a href="/blog3.html">Wedding Designs</a>
                                            </li>
                                            <li>
                                                <a href="/blog3.html">Flyer Designs</a>
                                            </li>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="/#">Background and Texture</a>
                                            </li>
                                            <li>
                                                <a href="/#">Icons</a>
                                            </li>
                                            <li>
                                                <a href="/#">Park and Outdoors</a>
                                            </li>
                                            <li>
                                                <a href="/#">Pattern</a>
                                            </li>
                                            ...
                                            <li>
                                                <a href="/#">Illustration and Clip Art</a>
                                            </li>
                                            <li>
                                                <a href="/#">Business</a>
                                            </li>
                                            ...
                                            <li>
                                                <a href="/#">ANimals and Wildlifes</a>
                                            </li>
                                            <li>
                                                <a href="/#">Art</a>
                                            </li>
                                    ...
                                    <li><a href="/credits.html">Buy Credits</a></li>
                            ...
                            <div class="col-sm-6">
                                <div class="cell-view page-height">
                                    ...
                                    <div data-swiper-parallax-x="-600">
                                        <div class="simple-article grey size-5">BEST PRICE <span
                                                    class="color">$199.00</span></div>
                                    ...
                                    <div data-swiper-parallax-x="-400">
                                        <div class="simple-article size-4 grey">In feugiat molestie tortor a
                                            malesuada. Etiam a venenatis ipsum. Proin pharetra elit at feugiat
                                            commodo vel placerat tincidunt sapien nec</div>
                            ...
                            <div class="product-preview-shortcode">
                                <div class="preview">
                                    ...
                                    <div class="entry full-size swiper-lazy active"
                                         data-background="img/product-preview-1.jpg"></div>
                                    <div class="entry full-size swiper-lazy"
                                         data-background="img/product-preview-2.jpg"></div>
                                    <div class="entry full-size swiper-lazy"
                                         data-background="img/product-preview-3.jpg"></div>
                                </div>
            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3">
                    <div class="tabs-block">
                        <div class="h4 col-xs-b25">latest products</div>
                        <div class="tab-entry visible">
                            <div class="row nopadding" id="products">
                                <div align="center">
                    ...
                    <div class="swiper-container arrows-align-top" data-breakpoints="1" data-xs-slides="1"
                        ...
                        <div class="swiper-wrapper" id="bestcategory">
                            <div align="center">
                                <i class="fa fa-spinner fa-spin fa-3x"></i> <br/>
                                ...loading....
                            </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="banner-shortcode style-1">
                                    <div class="background" style="background-image: url(img/thumbnail-10.jpg);">
                                    </div>
                                    <div class="description valign-middle">
                                        <div class="valign-middle-content">
                                            <div class="simple-article size-3 light fulltransparent">DON'T MISS!
                                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="banner-shortcode style-1">
                                    <div class="background" style="background-image: url(img/thumbnail-14.jpg);">
                                    </div>
                                    <div class="description valign-middle">
                                        <div class="valign-middle-content">
                                            <div class="simple-article size-3 light fulltransparent">DON'T MISS!
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="product-shortcode style-3">
                                    <div class="simple-article size-5 grey col-xs-b20">BEST PRICE: <span
                                                class="color">$299.00</span></div>
                                    <div class="products-line col-xs-b25">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 text-left">
                                                <div class="simple-article size-1">AVAILABLE: <span
                                                            class="grey">21</span></div>
                                            </div>
                                            <div class="col-xs-6 text-right">
                                                <div class="simple-article size-1">SOLD: <span
                                                            class="grey">14</span></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="description">
                                        <div class="simple-article size-2">Penatibus nec consequat at In feugiat
                                            mole stie tortor a malesuada natoque penatibus</div>
                                    </div>
                                    <div class="empty-space col-xs-b20"></div>
                                    ...
                                    <div class="product-shortcode style-1">
                                        <div class="title">
                                            <div class="simple-article size-1 color col-xs-b5"><a href="/#">SMART
                                                    PHONES</a></div>
                                            <div class="h6 animate-to-green"><a href="/#">Smartphone vibe x2</a>
                                            </div>
                                        </div>
                                        <div class="preview">
                                            ...
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="/productdetail.html">
                                                            <span class="button-wrapper">
                                                                <span class="icon"><img src="/img/icon-1.png"
                                                                                        alt=""></span>
                                                                <span class="text">Learn More</span>
                                                            </span>
                                                    </a>
                                        ...
                                        <div class="description">
                                            <div class="simple-article text size-2">Mollis nec consequat at In
                                                feugiat mole stie tortor a malesuada</div>
                                            <div class="icons">
                                                <a class="entry"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
                                        ...
                                        <div class="banner-shortcode style-2">
                                            <div class="content">
                                                <div class="background"
                                                     style="background-image: url(img/thumbnail-11.jpg);"></div>
                                                <div class="description valign-middle">
                                                    <div class="valign-middle-content">
                                                        <div class="simple-article size-1 color"><a
                                                                    href="/#">GADGETS</a></div>
                                                        <div class="h4 light"><a href="/#">cool sport gadget</a>
                                                        </div>
                                        ...
                                        <div class="product-shortcode style-1 text-center">
                                            <div class="title">
                                                <div class="simple-article size-1 color col-xs-b5"><a
                                                            href="/#">LAPTOPS</a></div>
                                                <div class="h6 animate-to-green"><a href="/#">high-end spectre
                                                        x360</a></div>
                                            </div>
                                            <div class="preview">
                                                <img src="/img/product-26.jpg" alt="">
    ...
    <div class="popup-content" data-rel="2">
        ...
        <div class="popup-container size-1">
            <div class="popup-align">
                ...
                <div class="empty-space col-xs-b30"></div>
                <input class="simple-input" type="email" value="" placeholder="Your email" />
                <div class="empty-space col-xs-b10 col-sm-b20"></div>
                <input class="simple-input" type="number" value="" placeholder="Phone Number" />
                <div class="empty-space col-xs-b10 col-sm-b20"></div>
                <input class="simple-input" type="password" value="" placeholder="Enter password" />
                <div class="empty-space col-xs-b10 col-sm-b20"></div>
                ...
                <div class="row">
                    <div class="col-sm-7 col-xs-b10 col-sm-b0">
                        ...
                        <label class="checkbox-entry">
                            <input type="checkbox" required /><span><a href="/#">Terms and Conditions</a></span>
                        </label>
                    </div>
            ...
            <div class="popup-align">
                <div class="row">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        ...
                                        <div class="product-big-preview-entry swiper-lazy"
                                             data-background="img/abby-beauty-saloon-550x550.jpg"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="swiper-lazy-preloader"></div>
                                        <div class="product-big-preview-entry swiper-lazy"
                                             data-background="img/2-abby-beauty-saloon-550x550.jpg"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="swiper-lazy-preloader"></div>
                                        <div class="product-big-preview-entry swiper-lazy"
                                             data-background="img/3-abby-beauty-saloon-550x550.jpg"></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product-small-preview-entry">
                                            <img src="/img/abby-beauty-saloon-550x550.jpg" alt="" height="70px"
                                                 width="70px" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product-small-preview-entry">
                                            <img src="/img/2-abby-beauty-saloon-550x550.jpg" alt="" height="70px"
                                                 width="70px" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product-small-preview-entry">
                                            <img src="/img/3-abby-beauty-saloon-550x550.jpg" alt="" height="70px"
                                                 width="70px" />
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="h3 col-xs-b25">Abby Beauty Saloon</div>
                        ...
                        <div class="simple-article size-3 col-xs-b30">Clearly labelled folders and layers
                            300dpi – Ready to print with guides
                            *Adobe Photoshop Cs3 version and above needed to edit this flyer!

                            Rate it you like it!
                            Follow me for more designs…
                            Fonts used link included</div>
                        <div class="row col-xs-b40">
                            <div class="col-sm-3">
                                <div class="h6 detail-data-title size-1">Format:</div>
                            </div>
                            <div class="col-sm-9">
                                <select class="SlectBox">
                                    <option disabled="disabled" selected="selected">Choose format</option>
                        ...
                        <div class="row col-xs-b40">
                            <label class="checkbox-entry">
                                <input type="checkbox"><span><b><em><strong>NOTE: </strong></em></b> Check if you
...
function loadimage(){
    axios.get('/api/product?num=6')
        .then(function (response) {
            // handle success

            //lastfeatured  = response.data.data[response.data.data.length - 1].ftid;
            ...
            if(response.data) {
                if (response.data.data.length > 0) {
                    ...
                    response.data.data.map((item) => {
                        ...
                        output += `<div class="col-sm-4">
                            <div class="product-shortcode style-1">
                            <div class="title">
                            <div class="simple-article size-1 color col-xs-b5"><a href="/#">${item.category_name}
                        </a></div>
                        <div class="h6 animate-to-green"><a href="/#">${item.title}</a>
                        </div>
                        </div>
                        <div class="preview">
                ...
                $("#spinner_results").hide();
                $("#search_results").html("<div class='col-md-6 offset-3'><div class='alert alert-info' align='center'>Your search for <strong>"+val+"</strong> returned no results</div></div>");
            }
                        ...
                        response.data.data.map((item) => {
                            ...
                            output += `<div class="swiper-slide">
                                <div class="product-shortcode style-1 small">
                                    <div class="title">
                                        <div class="simple-article size-1 color col-xs-b5"><a href="#">TEMPLATES</a>
                                        </div>
                                        <div class="h6 animate-to-green"><a href="#">Branding Mockups</a></div>
                                    </div>
                                    <div class="preview">
